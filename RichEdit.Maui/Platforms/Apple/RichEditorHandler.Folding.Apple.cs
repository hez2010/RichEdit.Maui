...
public partial class RichEditorHandler
{
    ...
    {
        if (PlatformView is null || _foldLayoutDelegate is null && VirtualView.Folding.EffectiveRanges.IsEmpty)
            return;
    ...
    {
        if (_foldLayoutDelegate is null)
            return;
